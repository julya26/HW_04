...
# n = map(int, input('Введите количество элементов первого множества: ').split())
# m = map(int, input('Введите количество элементов второго множества: ').split())
...
# n = int(input('Введите количество кустов'))           #объясните пожалуйста что не так?
